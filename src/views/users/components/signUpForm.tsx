...
export function SignUpForm() {
  ...
  function touch(field: "displayName" | "email" | "password", value: string) {
    setTouched((t) => ({ ...t, [field]: true }));
    validateField(field, value);
  }

  function validateField(field: "displayName" | "email" | "password", value: string) {
    let msg: string | undefined;
    if (field === "email") msg = fieldError(emailSchema, value);
    if (field === "password") msg = fieldError(passwordSchema, value);
    if (field === "displayName" && value.length > 80)
      msg = "Name must be 80 characters or fewer.";
    setErrors((e) => ({ ...e, [field]: msg }));
  }

  function onChange(field: "displayName" | "email" | "password", value: string) {
    ...
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input
          ...
          name="displayName"
          autoComplete="name"
          onBlur={(e) => touch("displayName", e.target.value)}
